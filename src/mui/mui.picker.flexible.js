 ...
 * by Houfeng
 * Houfeng@DCloud.io
 * updated by peter zhu @ 20160726
 * Depend On flexible.js 
 */

(function($, window, document, undefined) {

	var MAX_EXCEED = 30 * lib.flexible.dpr;
	var VISIBLE_RANGE = 90 * lib.flexible.dpr;
	var DEFAULT_ITEM_HEIGHT = 40 * lib.flexible.dpr;
	var BLUR_WIDTH = 10 * lib.flexible.dpr;
